...
(function (App) {
    ...
    class ProjectState extends State {
        ...
        addProject(title, description, numbOfPeople) {
            const project = new App.Project(title, description, numbOfPeople, Math.random().toString(), App.Status.ACTIVE);
    ...
    class ProjectList extends Component {
        ...
        dropHandler(event) {
            ...
            projectState.switchProject(prjId, this.type === 'active' ? App.Status.ACTIVE : App.Status.FINISHED);
            console.log(event);
        }
        ...
        config() {
            ...
            projectState.addListener((projects) => {
                const relevantProjects = projects.filter((prj) => {
                    if (this.type === "active") {
                        return prj.projectStatus === App.Status.ACTIVE;
                    }
                    return prj.projectStatus === App.Status.FINISHED;
                });
